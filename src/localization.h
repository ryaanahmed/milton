...
enum Texts
{
    ...
    TXT_default_brush_color,
    TXT_set_current_brush_color_as_default,
    ...
    TXT_Action_SET_BRUSH_COLOR_0,
    TXT_Action_SET_BRUSH_COLOR_1,
    TXT_Action_SET_BRUSH_COLOR_2,
    TXT_Action_SET_BRUSH_COLOR_3,
    TXT_Action_SET_BRUSH_COLOR_4,
    TXT_Action_HELP,
    TXT_Action_PEEK_OUT,
